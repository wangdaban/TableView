...
import com.evrencoskun.tableviewsample.tableview.UIUtil;
...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public ColumnHeaderViewHolder(View itemView, ITableView tableView) {
        ...
        arrow_up = ContextCompat.getDrawable(itemView.getContext(), R.mipmap.btn_add);
        arrow_down = ContextCompat.getDrawable(itemView.getContext(), R.mipmap.btn_add);
     ...
     */
    public void setColumnHeader(ColumnHeader columnHeader, int width) {
        ...
        column_header_container.getLayoutParams().width = width;
